...
public class LoginFrame implements ActionListener {
	...
	public void acceptChallenge(Message message){
		boolean yes = JOptionPane.showConfirmDialog(null, "Vill du acceptera spel fr�n: "+ message.getUserNameFrom(), "Nytt spel", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
		if (yes) {
